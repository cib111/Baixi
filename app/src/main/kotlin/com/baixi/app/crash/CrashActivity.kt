...
import com.baixi.app.ui.GlobalSnackbarHost
import com.baixi.app.ui.SnackbarController
import com.baixi.app.ui.items.CustomFabMenu
import com.baixi.app.ui.items.FabMenuItem
...
class CrashActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        // 崩溃文本超过 binder/Intent 安全长度时，处理器只传落盘文件路径（EXTRA_CRASH_LOG_PATH），
        // 这里读回文件内容；两者都没有才回退「未知错误」。
        val crashLog = intent.getStringExtra(CrashHandler.EXTRA_CRASH_LOG)
            ?: intent.getStringExtra(CrashHandler.EXTRA_CRASH_LOG_PATH)
