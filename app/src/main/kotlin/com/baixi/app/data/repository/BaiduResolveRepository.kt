 ...
 */
class BaiduResolveRepository(
    private val api: BaiduApi,
    /** 临时转存目录名提供者（设置页可配置，动态生效） */
    private val tempDirNameProvider: () -> String = { BaiduConstants.TEMP_DIR_NAME }
    ...
    override suspend fun listFiles(session: ShareSession, dirFid: String, cookie: String): Result<List<ShareFile>> =
        runCatching {
            ...
            var page = 1
            var result: com.baixi.app.data.network.BaiduShareList
            do {
    ...
    override suspend fun getShareDownloadLink(
        ...
        try {
            ...
            // appall 直链不依赖转存文件存活：无论取链成功或失败都删除临时转存，网盘不留残留
    ...
    private suspend fun deleteTransferred(path: String, cookie: String) {
        ...
        val tempDir = "/${tempDirNameProvider()}"
